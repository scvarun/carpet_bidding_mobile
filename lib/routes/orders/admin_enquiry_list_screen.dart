...
class AdminEnquiryListScreen extends StatelessWidget {
  static const routeName = '/admin/enquiries';

  const AdminEnquiryListScreen({Key? key}) : super(key: key);
    ...
    return BlocBuilder<AuthBloc, AuthState>(
      builder: (context, state) {
        if (state is AuthLoggedInState) {
          return const _AdminEnquiryListRender();
        }
        return Container();
      },
    );
...
class _AdminEnquiryListRender extends StatefulWidget {
  const _AdminEnquiryListRender({Key? key}) : super(key: key);

  @override
  State<_AdminEnquiryListRender> createState() =>
      __AdminEnquiryListRenderState();
}

class __AdminEnquiryListRenderState extends State<_AdminEnquiryListRender> {
      ...
      children: [
        ...
        Expanded(
          child: DataTable2(
            ...
            columns: [
              _columnTitle(context, 'Product', size: ColumnSize.S),
              _columnTitle(context, 'Dealer', size: ColumnSize.S),
              ...
              _columnTitle(context, 'Remarks', size: ColumnSize.L),
            ],
            empty: Container(
