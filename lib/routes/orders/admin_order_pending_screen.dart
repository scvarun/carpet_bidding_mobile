...
class AdminOrderPendingStockListScreen extends StatelessWidget {
  static const routeName = '/admin/pending';

  const AdminOrderPendingStockListScreen({Key? key}) : super(key: key);
    ...
    return BlocBuilder<AuthBloc, AuthState>(
      builder: (context, state) {
        if (state is AuthLoggedInState) {
          return const _AdminOrderPendingStockListRender();
        }
        return Container();
      },
    );
...
class _AdminOrderPendingStockListRender extends StatefulWidget {
  const _AdminOrderPendingStockListRender({Key? key}) : super(key: key);

  @override
  State<_AdminOrderPendingStockListRender> createState() =>
      __AdminOrderPendingStockListRenderState();
}

class __AdminOrderPendingStockListRenderState
    extends State<_AdminOrderPendingStockListRender> {
